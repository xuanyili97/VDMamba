...
def save_model(three_dim_model, optimizer, optimizer_flow, lr_scheduler, lr_scheduler_flow, opts):
...
def load_model(three_dim_model, optimizer, optimizer_flow,  lr_scheduler, lr_scheduler_flow, opts, epoch):
...
#        lr_scheduler_flow.load_state_dict(state_dict['lr_scheduler_flow'])
    ...
    '''
    return three_dim_model, optimizer, optimizer_flow, lr_scheduler, lr_scheduler_flow
...
#        data_loader = DataLoader(dataset=data_set, num_workers=0, batch_size=batch_size, sampler=sampler, pin_memory=False)
    else:
